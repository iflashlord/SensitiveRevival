...
public class TargetStoneElement extends StoneElement {
	private Image stoneImg = GameManager.getInst().getImage("/res/stones/target_stone.png");
	private Point pixelPos;
	
	
	public TargetStoneElement(GameBoard el, int bordPosX, int bordPosY) {
